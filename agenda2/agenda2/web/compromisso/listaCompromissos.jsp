...
Página Lista de compromissos

Está página possui funcionalidades úteis ao usuário, nela será exibida uma lista de com todos os
compromisso cadastrados em uma tabela dinâmica como os principais campos. Ao clicar nos nomes de seus
títulos os dados são organizados. Um botão de excluir e excluir poderão ser utilizados para excluir ou
alterar os compromissos, além de poder exportá-los para outros tipos de dados tais com PDF, CSV, XLS,
